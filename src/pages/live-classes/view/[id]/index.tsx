...
import { getLiveClassById } from 'apiSdk/live-classes';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Live Class Detail View
          </Text>
          {hasAccess('live_class', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/live-classes/edit/${data?.id}`} passHref legacyBehavior>
              <Button
