    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="monthly_payment" mb="4" isInvalid={!!formik.errors?.monthly_payment}>
            ...
            {formik.errors.monthly_payment && <FormErrorMessage>{formik.errors?.monthly_payment}</FormErrorMessage>}
          </FormControl>
